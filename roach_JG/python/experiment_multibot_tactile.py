...
def main():
    ...
    R1.SAVE_DATA = True # Cem: I made this true because the program hangs
    ...
    time.sleep(.5)
    #R1.startScan()
    R1.loadTactileForceCal(False,'../telemetry/N_matrix_trial9.mat')
    time.sleep(.5)
    #raw_input("send y")
    #R1.sendY(10)
    #raw_input("send z")
    ...
    #time.sleep(3)
    #raw_input()
    R1.RECORDSHELL = True # Cem: changing this to True
    #for i in range(10):
    #    R1.stopScan()
    #    time.sleep(.1)
    #raw_input()
